<script setup>
useHead({
    title: "Join the SealTech Team",
    description: "Competitive pay and engaging work.",
});
</script>
<template>
        ...
        <div class="container p-4 md:p-32 dark:text-white">
            ...
            <div class="md:px-32 space-y-4 mb-16">
                ...
                <ul>
                    Responsibilities:
                    <li>
                        Perform cleaning, maintenance, and inspections of solar
                        panel systems
                    </li>
                    <li>
                        Provide excellent customer service by addressing client
                        concerns and explaining maintenance procedures.
                    </li>
                    <li>
                        Ensure all safety protocols are followed, especially
                ...
                <ul>
                    ...
                    <li>
                        Prior experience in solar maintenance or a related field
            ...
            <div class="md:px-32 space-y-4">
                ...
                <p class="text-xl">
                    ...
                    first point of contact for inquiries, service bookings, and
                    general assistance.
                </p>
                ...
                <ul>
                    Responsibilities:
                    <li>
                        Handle customer inquiries via phone, email, and live
                        chat.
                    </li>
                    <li>
                        Schedule service appointments and manage technician
                        dispatches.
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        Proficiency in using customer service software and
                        tools.
                    </li>

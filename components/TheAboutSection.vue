...
<template>
    ...
    <div class="p-8" data-aos="fade-right">
        ...
        <p class="text-2xl md:w-3/4 mb-4">Your Concrete, Our Commitment</p>
            <p class="text-lg" >At SealTech Pro, we specialize in protecting and enhancing the durability of concrete surfaces. With our expert team and top-quality sealants, we ensure your driveways, patios, walkways, and commercial projects stand the test of time.</p>


            <div class="button-container justify-between py-8 flex flex-col md:flex-row  md:w-3/4">
            <NuxtLink to="/#services" class="hero-quote bg-blue-400 hover:bg-blue-200 p-2 rounded-md">learn more about us</NuxtLink>
